...
<body>
    <div id="main-content">
        ...
        <div id="isi">
                <h1 style="text-align: center;">List Admin</h1>
                <button data-target="#create" data-toggle="modal" style="background-color: #1abc9c; border:none;" class="btn btn-primary btn-lg btn-block">Input Admin Baru</button><br>
